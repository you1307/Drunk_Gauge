...
public class GameView extends SurfaceView implements Runnable {
    ...
    private void SpawnAndDeleteBackgroundStars() {
        ...
        if (backgroundStars.size() < 10) {
            BackgroundStar backgroundStar = new BackgroundStar(randomNum(screenx - 20, 20), 0, randomNum(AstroidConstants.BACKGROUND_STAR_MAX_SPEED, 5), screenSize, getResources());
